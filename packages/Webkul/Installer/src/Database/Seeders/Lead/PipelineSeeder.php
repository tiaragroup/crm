    ...
    public function run($parameters = [])
    {
        ...
        DB::table('lead_pipeline_stages')->insert($data = [
            [
                ...
                'id'               => 4,
                'code'             => 'site-visit',
                'name'             => trans('installer::app.seeders.lead.pipeline.pipeline-stages.site-visit', [], $defaultLocale),
                'probability'      => 50,
                'sort_order'       => 4,
                'lead_pipeline_id' => 1,
            ], [
                'id'               => 5,
                'code'             => 'proposal-sent',
                'name'             => trans('installer::app.seeders.lead.pipeline.pipeline-stages.proposal-sent', [], $defaultLocale),
                'probability'      => 65,
                'sort_order'       => 5,
                'lead_pipeline_id' => 1,
            ], [
