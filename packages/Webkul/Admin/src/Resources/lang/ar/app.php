...
return [
    ...
    'service-errors' => [
        ...
        'unsupported-proposal-language' => 'لغة العرض غير مدعومة.',
        'ai-not-configured'              => 'خدمة الذكاء الاصطناعي لمعالجة المستندات غير مهيأة.',
        'ai-truncated'                   => 'اقتُطعت استجابة الذكاء الاصطناعي. زد الحد الأقصى لرموز إخراج Claude.',
        'ai-invalid-data'                => 'أعادت خدمة الذكاء الاصطناعي بيانات منظمة غير صالحة.',
        'ai-invalid-mode'                => 'وضع استخراج الذكاء الاصطناعي غير صالح.',
        'ai-invalid-bulk'                => 'استجابة الاستخراج الجماعي غير صالحة أو كبيرة جداً.',
        'ai-invalid-shape'               => 'بنية قسم :section المستخرجة غير صالحة.',
        'ai-invalid-confidence'          => 'قيمة ثقة الذكاء الاصطناعي غير صالحة.',
        'unsupported-document'           => 'نوع المستند غير مدعوم.',
        'scanned-pdf'                    => 'قد يكون ملف PDF ممسوحاً ضوئياً أو يحتوي على صور فقط. ميزة OCR غير متاحة في الإصدار الأول.',
        'spreadsheet-limit'              => 'يتجاوز جدول البيانات حد الاستيراد البالغ :count صفاً.',
        'spreadsheet-empty'              => 'لا يحتوي جدول البيانات على أي صفوف بيانات.',
    ],

    'attribute-labels' => [
        'leads' => [
            'title'                  => 'اسم الفرصة',
            'description'            => 'المتطلبات / ملاحظات المبيعات',
            'lead_value'             => 'القيمة التقديرية للفرصة',
            'lead_source_id'         => 'المصدر',
            'lead_type_id'           => 'علاقة العميل',
            'user_id'                => 'مندوب المبيعات',
            'expected_close_date'    => 'الموعد المتوقع لاتخاذ القرار',
            'lead_pipeline_id'       => 'مسار المبيعات',
            'lead_pipeline_stage_id' => 'المرحلة',
            'opportunity_type'       => 'نوع الفرصة',
            'event_date'             => 'تاريخ الفعالية',
            'interested_services'    => 'الخدمات المطلوبة',
            'guest_count'            => 'العدد التقديري للضيوف',
            'venue_location'         => 'موقع الفعالية',
            'event_type'             => 'نوع الفعالية',
            'service_style'          => 'أسلوب الخدمة',
            'dietary_requirements'   => 'المتطلبات الغذائية / الحساسية',
            'business_category'      => 'فئة النشاط',
            'catering_frequency'     => 'معدل طلب خدمات الضيافة المتوقع',
            'potential_guest_volume' => 'العدد المحتمل للضيوف / حجم الطلب',
            'next_follow_up_date'    => 'تاريخ المتابعة القادمة',
            'budget_range'           => 'نطاق الميزانية التقديرية',
            'date_flexibility'       => 'مرونة تاريخ الفعالية',
        ],
    ],
    ...
    'attribute-options' => [
        'lead_source_id' => [
            ...
            'walk-in-direct'             => 'زيارة مباشرة',
            'whatsapp'                   => 'واتساب',
            'instagram-social-media'     => 'إنستغرام / وسائل التواصل',
            'referral'                   => 'إحالة',
            'event-planner-agency'       => 'منظم فعاليات / وكالة',
        ],
        'lead_type_id' => [
            'new-catering-client'       => 'عميل ضيافة جديد',
            'returning-catering-client' => 'عميل ضيافة حالي',
        ],
        'opportunity_type' => [
            'event-inquiry'    => 'استفسار عن فعالية',
            'account-prospect' => 'عميل محتمل بدون فعالية',
        ],
        'interested_services' => [
            'full-service-catering' => 'خدمة ضيافة متكاملة',
            'drop-off-catering'     => 'توصيل الطعام فقط',
            'corporate-meals'       => 'وجبات الشركات',
            'buffet'                => 'بوفيه',
            'plated-service'        => 'خدمة أطباق فردية',
            'canapes-reception'     => 'مقبلات / استقبال',
            'beverage-service'      => 'خدمة المشروبات',
            'staffing'              => 'طاقم خدمة',
            'equipment-rentals'     => 'معدات / تأجير',
            'venue-required'        => 'مطلوب موقع للفعالية',
            'not-decided'           => 'لم يُحدد بعد',
        ],
        'event_type' => [
            'corporate-event'          => 'فعالية شركة',
            'wedding'                  => 'حفل زفاف',
            'private-party'            => 'حفلة خاصة',
            'government-institutional' => 'جهة حكومية / مؤسسية',
            'conference-exhibition'    => 'مؤتمر / معرض',
            'other'                    => 'أخرى',
        ],
        'service_style' => [
            'buffet'            => 'بوفيه',
            'plated-service'    => 'خدمة أطباق فردية',
            'canapes-reception' => 'مقبلات / استقبال',
            'food-stations'     => 'محطات طعام',
            'drop-off-catering' => 'توصيل الطعام فقط',
            'staffed-catering'  => 'ضيافة مع طاقم خدمة',
        ],
        'business_category' => [
            'corporate-office'       => 'مكتب شركة',
            'government-institution' => 'جهة حكومية / مؤسسة',
            'event-planner-agency'   => 'منظم فعاليات / وكالة',
            'venue-hotel'            => 'قاعة / فندق',
            'school-university'      => 'مدرسة / جامعة',
            'healthcare'             => 'رعاية صحية',
            'private-client'         => 'عميل فردي',
            'other'                  => 'أخرى',
        ],
        'catering_frequency' => [
            'one-time'            => 'مرة واحدة',
            ...
            'monthly'             => 'شهرياً',
            'quarterly'           => 'ربع سنوي',
            'seasonal-occasional' => 'موسمي / عند المناسبات',
            'unknown'             => 'غير معروف',
        ],
        'budget_range' => [
            'not-known'        => 'غير معروف',
            'under-sar-10000'  => 'أقل من 10,000 ر.س',
            'sar-10000-25000'  => '10,000 - 25,000 ر.س',
            'sar-25000-50000'  => '25,000 - 50,000 ر.س',
            'sar-50000-100000' => '50,000 - 100,000 ر.س',
            'above-sar-100000' => 'أكثر من 100,000 ر.س',
        ],
        'date_flexibility' => [
            'fixed-date'               => 'تاريخ ثابت',
            'flexible-by-a-few-days'   => 'مرن لعدة أيام',
            'month-only-not-confirmed' => 'الشهر فقط / غير مؤكد',
    ...
    'components' => [
        ...
        'layouts' => [
            'powered-by' => [
                'description' => 'مدعوم بواسطة :krayin، وهو مشروع مفتوح المصدر من :webkul.',
            ],
            'header' => [
                'mega-search' => [
                    'title' => 'البحث الشامل',
    ...
    'quotes' => [
        'form' => [
            'create-title'             => 'إنشاء عرض خدمات ضيافة',
            'edit-title'               => 'تعديل عرض خدمات الضيافة',
            'revision'                 => 'المراجعة :number',
            'download-word'            => 'تنزيل Word',
            'download-pdf'             => 'تنزيل PDF',
            'save'                     => 'حفظ العرض',
            'export-title'             => 'تصدير عرض السعر بصيغة PDF',
            'export-info'              => 'اختر لغة المستند.',
            'english'                  => 'الإنجليزية',
            'english-info'             => 'عرض سعر قياسي من اليسار إلى اليمين',
            'arabic'                   => 'العربية',
            'arabic-info'              => 'عرض سعر كامل من اليمين إلى اليسار',
            'export-note'              => 'تبقى بيانات عرض السعر كما هي؛ تتغير لغة ملف PDF المصدّر فقط.',
            'validation-title'         => 'يرجى تصحيح معلومات عرض السعر.',
            'proposal-client'          => 'العرض والعميل',
            'proposal-client-info'     => 'المعلومات التي تظهر للعميل في صفحة الغلاف.',
            'subject'                  => 'موضوع العرض',
            'reference'                => 'مرجع العرض',
            'reference-placeholder'    => 'يُنشأ بعد الحفظ',
            'sales-owner'              => 'مسؤول المبيعات',
            'select-sales-owner'       => 'اختر مسؤول المبيعات',
            'issue-date'               => 'تاريخ الإصدار',
            'valid-until'              => 'صالح حتى',
            'crm-contact'              => 'جهة الاتصال في CRM',
            'contact-search'           => 'اكتب حرفين على الأقل للبحث بالاسم أو الشركة أو البريد أو الجوال',
            'searching'                => 'جارٍ البحث…',
            'search-minimum'           => 'أدخل حرفين على الأقل للبحث في جهات الاتصال.',
            'no-contact-details'       => 'لا توجد تفاصيل إضافية',
            'no-contact-results'       => 'لم يتم العثور على جهة اتصال مطابقة.',
            ...
            'contact-info'             => 'تُؤخذ بيانات جهة الاتصال مباشرة من سجل CRM وتُستخدم في العرض.',
            'introduction'             => 'المقدمة',
            'event-details'            => 'تفاصيل الفعالية',
            'event-details-info'       => 'المعلومات التشغيلية التي تظهر في ملخص الفعالية.',
            'event-type'               => 'نوع الفعالية',
            'event-type-placeholder'   => 'استقبال، زفاف، فعالية شركة…',
            'event-date-time'          => 'تاريخ ووقت الفعالية',
            'venue'                    => 'الموقع',
            'guest-count'              => 'عدد الضيوف',
            'setup-description'        => 'وصف التجهيز',
            'service-inclusions'       => 'الخدمات المشمولة',
            'one-per-line'             => 'خدمة واحدة في كل سطر',
            'menu-builder'             => 'منشئ قائمة الطعام',
            'menu-builder-info'        => 'طبّق قائمة ثم خصّص هذا العرض دون تغيير الكتالوج.',
            'choose-menu'              => 'اختر قائمة ضيافة',
            'per-person-suffix'        => 'للشخص',
            'apply-menu'               => 'تطبيق القائمة',
            'create-menu'              => 'إنشاء قائمة',
            'empty-menu'               => 'اختر قائمة أو أضف أول قسم في قائمة الطعام.',
            'menu-section-placeholder' => 'قسم القائمة',
            'remove'                   => 'إزالة',
            'dish-name'                => 'اسم الطبق',
            'optional-description'     => 'وصف اختياري',
            'remove-dish'              => 'إزالة الطبق',
            'catalog-item'             => 'إضافة صنف من الكتالوج',
            'add-item'                 => 'إضافة صنف',
            'custom-item'              => 'صنف مخصص',
            'add-menu-section'         => 'إضافة قسم للقائمة',
            'pricing'                  => 'التسعير',
            'pricing-info'             => 'يدعم التسعير للشخص والسعر الثابت والأصناف المشمولة.',
            'add-row'                  => 'إضافة صف',
            'description'              => 'الوصف',
            'type'                     => 'النوع',
            'price'                    => 'السعر',
            'quantity-guests'          => 'الكمية / الضيوف',
            'discount'                 => 'الخصم',
            'total'                    => 'الإجمالي',
            'optional-detail'          => 'تفاصيل اختيارية',
            'per-person'               => 'للشخص',
            'fixed'                    => 'سعر ثابت',
            'included'                 => 'مشمول',
            'terms-title'              => 'الشروط والبنك والاعتماد',
            'terms-info'               => 'محتوى الصفحة الأخيرة من العرض.',
            'pricing-vat-terms'        => 'شروط التسعير وضريبة القيمة المضافة',
            'payment-terms'            => 'شروط الدفع',
            'changes-terms'            => 'شروط التغييرات',
            'cancellation-terms'       => 'شروط الإلغاء',
            'account-name'             => 'اسم الحساب',
            'bank'                     => 'البنك',
            'iban'                     => 'رقم الآيبان',
            'tiara-signatory'          => 'المفوّض بالتوقيع من تيارا',
            'tiara-signatory-title'    => 'صفة مفوّض تيارا',
            'client-signatory'         => 'المفوّض بالتوقيع من العميل',
            'client-signatory-title'   => 'صفة مفوّض العميل',
            'summary'                  => 'ملخص العرض',
            'guests'                   => 'الضيوف',
            ...
            'totals-note'              => 'تُعاد حساب الإجماليات بأمان عند الحفظ وتُخزّن في نسخة التصدير.',
            'add-contact-title'        => 'إضافة جهة اتصال جديدة إلى CRM',
            'contact-name'             => 'اسم جهة الاتصال',
            'cancel'                   => 'إلغاء',
            'saving'                   => 'جارٍ الحفظ…',
            'save-contact'             => 'حفظ جهة الاتصال',
            'search-failed'            => 'تعذر البحث في جهات اتصال CRM.',
            'contact-required'         => 'اسم جهة الاتصال والبريد الإلكتروني مطلوبان.',
            'contact-created'          => 'تم إنشاء جهة الاتصال واختيارها.',
            'contact-create-failed'    => 'تعذر إنشاء جهة الاتصال.',
            'new-menu-section'         => 'قسم قائمة جديد',
            'unnamed-dish'             => 'طبق بدون اسم',
            'menu'                     => 'القائمة',
            'default-package'          => 'باقة ضيافة',
            'default-subject'          => 'عرض خدمات ضيافة',
            'default-description'      => 'عرض لخدمات الضيافة',
            'collapse'                 => 'طي',
            'edit-dishes'              => 'تعديل الأطباق (:count)',
            'currency'                 => 'ر.س',
            'statuses'                 => [
                'draft'    => 'مسودة',
                'sent'     => 'مرسل',
    ...
    'leads' => [
        ...
        'update-failed'   => 'تعذر تحديث فرصة المبيعات.',
        'destroy-success' => 'تم حذف العميل المحتمل بنجاح.',
        'destroy-failed'  => 'لا يمكن حذف العميل المحتمل.',

        'opportunity' => [
            'type'                  => 'نوع الفرصة',
            'interests'             => 'الخدمات المطلوبة',
            'interests-info'        => 'سجّل الاهتمامات العامة فقط. تُحدد القوائم والكميات والأسعار داخل عرض السعر.',
            'event-details'         => 'تفاصيل استفسار الفعالية',
            'event-details-info'    => 'أكمل المعلومات المتوفرة حالياً. يمكن ترك تاريخ الفعالية والموقع غير مؤكدين.',
            'prospect-details'      => 'تفاصيل العميل المحتمل',
            'prospect-details-info' => 'استخدم هذا المسار لتطوير الأعمال عندما لا يملك العميل فعالية محددة بعد.',
            'event-help-title'      => 'توجد فعالية قيد المناقشة',
            'event-help-text'       => 'ستتبع هذه الفرصة مسار مبيعات الفعاليات من التأهيل حتى تقديم عرض السعر.',
            'prospect-help-title'   => 'لا توجد فعالية مطلوبة حالياً',
            'prospect-help-text'    => 'ستتبع هذه الفرصة مسار استقطاب العملاء. عيّن مندوب المبيعات ثم جدوِل الاجتماعات أو الزيارات ضمن المتابعات.',
            'quotation-note'        => 'تُدار القوائم والأصناف والكميات والأسعار والخصومات والضريبة والمراجعات داخل عرض السعر فقط.',
        ],
        ...
        'index' => [
            ...
            'kanban' => [
                ...
                'stage-names' => [
                    ...
                    'Qualified'                 => 'مؤهل',
                    'Qualified / Discovery'     => 'مؤهل / استكشاف',
                    'Proposal in Preparation'   => 'العرض قيد الإعداد',
                    'Proposal Sent'             => 'تم إرسال العرض',
                    'Negotiation / Revision'    => 'التفاوض / المراجعة',
                    'Confirmed / Won'           => 'مؤكد / تم الفوز',
                    'Lost'                      => 'خسارة',
                    'New Prospect'              => 'عميل محتمل جديد',
                    'Assigned'                  => 'تم التعيين',
                    'Meeting / Visit Scheduled' => 'تم جدولة اجتماع / زيارة',
                    'Qualified Account'         => 'حساب مؤهل',
                    'Nurture / Follow-up'       => 'متابعة / رعاية العميل',
                    'Event Opportunity Created' => 'تم إنشاء فرصة فعالية',
                    'Disqualified / Lost'       => 'غير مؤهل / مفقود',
                ],
                'columns'                => [
                    'contact-person'      => 'شخص الاتصال',
                    'id'                  => 'ID',
        ...
        'create' => [
            'title'          => 'إنشاء فرصة مبيعات',
            'save-btn'       => 'حفظ',
            'details'        => 'التفاصيل',
            'details-info'   => 'ابدأ باستفسار عن فعالية أو عميل ضيافة محتمل',
            'contact-person' => 'جهة الاتصال',
            'contact-info'   => 'معلومات جهة الاتصال',
            'products'       => 'القوائم والخدمات',
            'products-info'  => 'القوائم والباقات والتأجير والخدمات المطلوبة',
        ],
        'edit' => [
            'title'          => 'تعديل فرصة المبيعات',
            'save-btn'       => 'حفظ',
            'details'        => 'التفاصيل',
            'details-info'   => 'حدّث تفاصيل الفرصة والتأهيل ومسؤول المبيعات',
            'contact-person' => 'جهة الاتصال',
            'contact-info'   => 'معلومات جهة الاتصال',
            'products'       => 'القوائم والخدمات',
            'products-info'  => 'القوائم والباقات والتأجير والخدمات المطلوبة',
    ...
    'configuration' => [
        'index' => [
            ...
            'general'        => [
                ...
                'settings' => [
                    'title'  => 'الإعدادات',
                    'info'   => 'حدّث إعدادات النظام من هنا.',
                    'footer' => [
                        'info'       => 'يمكنك تخصيص النص الظاهر في تذييل النظام من هنا.',
                        'powered-by' => 'نص حقوق التشغيل',
                        'title'      => 'إعدادات تذييل النظام',
                    ],
                    'menu' => [
                        ...
                        'draft'         => 'المسودات',
                        'inbox'         => 'البريد الوارد',
                        'info'          => 'يمكنك تخصيص أسماء عناصر القائمة من هنا.',
                        'leads'         => 'العملاء المحتملون',
                        'mail'          => 'البريد',
                    ...
                    'menu-color' => [
                        ...
                        'info'        => 'يمكنك تغيير لون عناصر القائمة من هنا.',
    ...
    'catering-menus' => [
        'title'                     => 'قوائم الطعام',
        'breadcrumb'                => 'المنتجات / قوائم الطعام',
        'description'               => 'أنشئ قوائم قابلة لإعادة الاستخدام ليطبقها فريق المبيعات على أي عرض.',
        'create'                    => 'إنشاء قائمة',
        'create-first'              => 'إنشاء أول قائمة',
        'empty-title'               => 'لا توجد قوائم طعام بعد',
        'empty-description'         => 'أنشئ قائمتك الأولى واختر أطباقها لتظهر في منشئ العروض.',
        'menu'                      => 'القائمة',
        'price-per-person'          => 'السعر للفرد',
        'minimum-guests'            => 'الحد الأدنى للضيوف',
        'dishes'                    => 'الأطباق',
        'status'                    => 'الحالة',
        'actions'                   => 'الإجراءات',
        ...
        'edit'                      => 'تعديل',
        'delete'                    => 'حذف',
        'delete-confirmation'       => 'هل تريد حذف قائمة الطعام هذه؟',
        'edit-title'                => 'تعديل قائمة الطعام',
        'create-title'              => 'إنشاء قائمة طعام',
        'cancel'                    => 'إلغاء',
        'save-changes'              => 'حفظ التغييرات',
        'validation-title'          => 'يرجى تصحيح معلومات القائمة.',
        'details'                   => 'تفاصيل القائمة',
        'details-description'       => 'تُنسخ هذه المعلومات إلى العرض عند تطبيق فريق المبيعات للقائمة.',
        'name-en'                   => 'اسم القائمة (بالإنجليزية)',
        'name-ar'                   => 'اسم القائمة (بالعربية)',
        'name-placeholder'          => 'مثال: القائمة الأولى',
        'client-description-en'     => 'الوصف الموجّه للعميل (بالإنجليزية)',
        'client-description-ar'     => 'الوصف الموجّه للعميل (بالعربية)',
        'description-placeholder'   => 'وصف مختصر للقائمة',
        'price-per-person-sar'      => 'السعر للفرد (ر.س)',
        'optional'                  => 'اختياري',
        'setup-description-en'      => 'وصف التجهيز (بالإنجليزية)',
        'setup-description-ar'      => 'وصف التجهيز (بالعربية)',
        'setup-placeholder'         => 'طاولات البوفيه، المفارش، المعدات، أسلوب التجهيز…',
        'service-inclusions-en'     => 'الخدمات المشمولة (بالإنجليزية)',
        'service-inclusions-ar'     => 'الخدمات المشمولة (بالعربية)',
        'one-per-line'              => 'عنصر واحد في كل سطر',
        'service-placeholder'       => "طاقم الخدمة\nالمشرفون\nمعدات التقديم",
        'choose-dishes'             => 'اختيار الأطباق',
        'choose-dishes-description' => 'اختر الأطباق من كتالوج المنتجات؛ فهي مجمّعة مسبقاً ضمن أقسام العرض.',
        'available-count'           => ':count متاح',
        'no-active-dishes'          => 'لا توجد أطباق نشطة في هذه الفئة.',
        'need-dish'                 => 'تحتاج إلى طبق آخر؟ أنشئه ضمن المنتجات، وحدد فئة قائمة الطعام، ثم عد إلى هنا.',
        'availability'              => 'التوفر',
        'availability-description'  => 'تبقى القوائم غير النشطة محفوظة، لكنها لا تظهر في منشئ العروض.',
        'active-menu'               => 'قائمة نشطة',
        'available-to-sales'        => 'متاحة لمستخدمي المبيعات',
        'future-proposals-note'     => 'تؤثر التغييرات في العروض المستقبلية، بينما تحتفظ العروض الحالية بنسختها المحفوظة من القائمة.',
        'create-success'            => 'تم إنشاء قائمة الطعام بنجاح.',
        'update-success'            => 'تم تحديث قائمة الطعام بنجاح.',
        'delete-success'            => 'تم حذف قائمة الطعام بنجاح.',
    ],

    'catering-products' => [
        'title'                 => 'كتالوج الضيافة',
        'description'           => 'يتحكم في كيفية ظهور هذا المنتج ضمن باقات قوائم العروض.',
        'arabic-name'           => 'الاسم بالعربية',
        'arabic-description'    => 'الوصف بالعربية',
        'menu-section'          => 'قسم القائمة',
        'select-category'       => 'اختر الفئة',
        'unit-type'             => 'نوع الوحدة',
        'unit-types'            => ['menu-item' => 'عنصر قائمة', 'per-person' => 'لكل فرد', 'fixed' => 'سعر ثابت', 'included' => 'مشمول'],
        'allergens'             => 'مسببات الحساسية / الملاحظات الغذائية',
        'allergens-placeholder' => 'الجلوتين، الألبان، المكسرات…',
        'arabic-allergens'      => 'مسببات الحساسية بالعربية',
        'display-order'         => 'ترتيب العرض في القائمة',
        'available'             => 'متاح في عروض الضيافة',
    ],

    'custom-ui' => [
        'proposal-reference' => 'مرجع العرض',
        'event-date'         => 'تاريخ الفعالية',
        'guests'             => 'الضيوف',
        'status'             => 'الحالة',
        'download-word'      => 'تنزيل ملف وورد',
        'arabic-name'        => 'الاسم بالعربية',
        'search'             => 'بحث…',
        'key'                => 'المفتاح',
        'value'              => 'القيمة',
