...
return [
    ...
    'service-errors' => [
        ...
        'ai-invalid-mode'               => 'Invalid AI extraction mode.',
        'ai-invalid-bulk'               => 'Invalid or oversized bulk AI response.',
        'ai-invalid-shape'              => 'Invalid AI :section structure.',
        'ai-invalid-confidence'         => 'Invalid AI confidence value.',
        'unsupported-document'          => 'Unsupported document type.',
        'scanned-pdf'                   => 'This PDF may be scanned or image-only. OCR is not available in version 1.',
        'spreadsheet-limit'             => 'Spreadsheet exceeds the :count-row import limit.',
        'spreadsheet-empty'             => 'The spreadsheet does not contain any data rows.',
    ],
    ...
    'quotes' => [
        'form' => [
            'create-title'             => 'Create Catering Proposal',
            'edit-title'               => 'Edit Catering Proposal',
            'revision'                 => 'Revision :number',
            'download-word'            => 'Download Word',
            'download-pdf'             => 'Download PDF',
            'save'                     => 'Save Proposal',
            'export-title'             => 'Export quotation PDF',
            'export-info'              => 'Choose the language for this document.',
            'english'                  => 'English',
            'english-info'             => 'Standard left-to-right quotation',
            'arabic'                   => 'Arabic',
            'arabic-info'              => 'Complete right-to-left quotation',
            'export-note'              => 'Your quotation data stays unchanged; only the exported PDF language changes.',
            'validation-title'         => 'Please correct the proposal information.',
            'proposal-client'          => 'Proposal & Client',
            'proposal-client-info'     => 'Cover-page information shown to the client.',
            'subject'                  => 'Proposal subject',
            'reference'                => 'Proposal reference',
            'reference-placeholder'    => 'Generated after save',
            'sales-owner'              => 'Sales owner',
            'select-sales-owner'       => 'Select sales owner',
            'issue-date'               => 'Issue date',
            'valid-until'              => 'Valid until',
            'crm-contact'              => 'CRM contact',
            'contact-search'           => 'Type at least 2 characters to search by name, company, email, or mobile',
            'searching'                => 'Searching…',
            'search-minimum'           => 'Enter at least 2 characters to search CRM contacts.',
            'no-contact-details'       => 'No additional details',
            'no-contact-results'       => 'No matching CRM contacts found.',
            ...
            'contact-info'             => 'Contact details are taken directly from the CRM contact record and used in the proposal.',
            'introduction'             => 'Introduction',
            'event-details'            => 'Event Details',
            'event-details-info'       => 'Operational information printed in the event summary.',
            'event-type'               => 'Event type',
            'event-type-placeholder'   => 'Reception, wedding, corporate event…',
            ...
            'menu-builder-info'        => 'Apply a menu, then customize this proposal without changing the catalog.',
            'choose-menu'              => 'Choose catering menu',
            'per-person-suffix'        => 'person',
            'apply-menu'               => 'Apply Menu',
            'create-menu'              => 'Create Menu',
            'empty-menu'               => 'Choose a menu or add the first menu section.',
            'menu-section-placeholder' => 'Menu section',
            'remove'                   => 'Remove',
            'dish-name'                => 'Dish name',
            'optional-description'     => 'Optional description',
            'remove-dish'              => 'Remove dish',
            'catalog-item'             => 'Add item from catalog',
            'add-item'                 => 'Add Item',
            'custom-item'              => 'Custom Item',
            'add-menu-section'         => 'Add Menu Section',
            'pricing'                  => 'Pricing',
            'pricing-info'             => 'Per-person, fixed, and included rows are supported.',
            'add-row'                  => 'Add Row',
            'description'              => 'Description',
            'type'                     => 'Type',
            'price'                    => 'Price',
            'quantity-guests'          => 'Qty / Guests',
            'discount'                 => 'Discount',
            'total'                    => 'Total',
            ...
            'fixed'                    => 'Fixed',
            'included'                 => 'Included',
            'terms-title'              => 'Terms, Bank & Approval',
            'terms-info'               => 'Content for the final proposal page.',
            'pricing-vat-terms'        => 'Pricing & VAT terms',
            'payment-terms'            => 'Payment terms',
            'changes-terms'            => 'Changes terms',
            'cancellation-terms'       => 'Cancellation terms',
            'account-name'             => 'Account name',
            'bank'                     => 'Bank',
            'iban'                     => 'IBAN',
            'tiara-signatory'          => 'Tiara signatory',
            'tiara-signatory-title'    => 'Tiara signatory title',
            'client-signatory'         => 'Client signatory',
            'client-signatory-title'   => 'Client signatory title',
            ...
            'totals-note'              => 'Totals are recalculated securely when saved and stored in the export snapshot.',
            'add-contact-title'        => 'Add new CRM contact',
            'contact-name'             => 'Contact name',
            'cancel'                   => 'Cancel',
            'saving'                   => 'Saving…',
            'save-contact'             => 'Save contact',
            'search-failed'            => 'Unable to search CRM contacts.',
            'contact-required'         => 'Contact name and email are required.',
            'contact-created'          => 'Contact created and selected.',
            'contact-create-failed'    => 'Unable to create the contact.',
            'new-menu-section'         => 'New Menu Section',
            'unnamed-dish'             => 'Unnamed dish',
            'menu'                     => 'Menu',
            'default-package'          => 'Catering Package',
            'default-subject'          => 'Catering Function Proposal',
            'default-description'      => 'Catering function proposal',
            'collapse'                 => 'Collapse',
            'edit-dishes'              => 'Edit :count dishes',
            'currency'                 => 'SAR',
            'statuses'                 => [
                'draft'    => 'Draft',
                'sent'     => 'Sent',
        ...
        'index' => [
            ...
            'kanban' => [
                ...
                'stage-names' => [
                    ...
                    'Negotiation / Revision'    => 'Negotiation / Revision',
                    'Confirmed / Won'           => 'Confirmed / Won',
                    'Lost'                      => 'Lost',
                    'New Prospect'              => 'New Prospect',
                    'Assigned'                  => 'Assigned',
                    'Meeting / Visit Scheduled' => 'Meeting / Visit Scheduled',
                    'Qualified Account'         => 'Qualified Account',
                    'Nurture / Follow-up'       => 'Nurture / Follow-up',
                    'Event Opportunity Created' => 'Event Opportunity Created',
                    'Disqualified / Lost'       => 'Disqualified / Lost',
                ],
    ...
    'catering-menus' => [
        ...
        'breadcrumb'                => 'Products / Catering Menus',
        'description'               => 'Create reusable menus that sales can apply to any proposal.',
        'create'                    => 'Create Menu',
        'create-first'              => 'Create First Menu',
        'empty-title'               => 'No catering menus yet',
        'empty-description'         => 'Create your first menu, choose its dishes, and it will appear in the proposal builder.',
        'menu'                      => 'Menu',
        'price-per-person'          => 'Price / person',
        'minimum-guests'            => 'Minimum guests',
        'dishes'                    => 'Dishes',
        'status'                    => 'Status',
        'actions'                   => 'Actions',
        ...
        'edit'                      => 'Edit',
        'delete'                    => 'Delete',
        'delete-confirmation'       => 'Delete this catering menu?',
        'edit-title'                => 'Edit Catering Menu',
        'create-title'              => 'Create Catering Menu',
        'cancel'                    => 'Cancel',
        'save-changes'              => 'Save Changes',
        'validation-title'          => 'Please correct the menu information.',
        'details'                   => 'Menu Details',
        'details-description'       => 'This information is copied into a proposal when sales applies the menu.',
        'name-en'                   => 'Menu name (English)',
        'name-ar'                   => 'Menu name (Arabic)',
        'name-placeholder'          => 'Example: Menu One',
        'client-description-en'     => 'Client-facing description (English)',
        'client-description-ar'     => 'Client-facing description (Arabic)',
        'description-placeholder'   => 'Short description of the menu',
        'price-per-person-sar'      => 'Price per person (SAR)',
        'optional'                  => 'Optional',
        'setup-description-en'      => 'Setup description (English)',
        'setup-description-ar'      => 'Setup description (Arabic)',
        'setup-placeholder'         => 'Buffet tables, linens, equipment, setup style…',
        'service-inclusions-en'     => 'Service inclusions (English)',
        'service-inclusions-ar'     => 'Service inclusions (Arabic)',
        'one-per-line'              => 'one per line',
        'service-placeholder'       => "Waiters\nSupervisors\nServing equipment",
        'choose-dishes'             => 'Choose Dishes',
        'choose-dishes-description' => 'Select dishes from your product catalog. They are already grouped into proposal sections.',
        'available-count'           => ':count available',
        'no-active-dishes'          => 'No active dishes in this category.',
        'need-dish'                 => 'Need another dish? Create it under Products, assign its catering category, then return here.',
        'availability'              => 'Availability',
        'availability-description'  => 'Inactive menus stay saved but do not appear in the proposal builder.',
        'active-menu'               => 'Active menu',
        'available-to-sales'        => 'Available to sales users',
        'future-proposals-note'     => 'Changes affect future proposals. Existing proposals keep their own saved menu snapshot.',
        'create-success'            => 'Catering menu created successfully.',
        'update-success'            => 'Catering menu updated successfully.',
        'delete-success'            => 'Catering menu deleted successfully.',
    ],

    'catering-products' => [
        'title'                 => 'Catering Catalog',
        'description'           => 'Controls how this product appears in proposal menu packages.',
        'arabic-name'           => 'Arabic name',
        'arabic-description'    => 'Arabic description',
        'menu-section'          => 'Menu section',
        'select-category'       => 'Select category',
        'unit-type'             => 'Unit type',
        'unit-types'            => ['menu-item' => 'Menu item', 'per-person' => 'Per person', 'fixed' => 'Fixed price', 'included' => 'Included'],
        'allergens'             => 'Allergens / dietary notes',
        'allergens-placeholder' => 'Gluten, dairy, nuts…',
        'arabic-allergens'      => 'Arabic allergens',
        'display-order'         => 'Menu display order',
        'available'             => 'Available in catering proposals',
    ],
